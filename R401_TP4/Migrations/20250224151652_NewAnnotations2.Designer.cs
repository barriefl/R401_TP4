...
namespace R401_TP4.Migrations
{
    ...
    [Migration("20250224151652_NewAnnotations2")]
    partial class NewAnnotations2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("R401_TP4.Models.EntityFramework.Film", b =>
                {
            ...
            modelBuilder.Entity("R401_TP4.Models.EntityFramework.Notation", b =>
                {
            ...
            modelBuilder.Entity("R401_TP4.Models.EntityFramework.Utilisateur", b =>
                {
                    b.Property<int>("UtilisateurId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("R401_TP4.Models.EntityFramework.Notation", b =>
                {
                    b.HasOne("R401_TP4.Models.EntityFramework.Film", "FilmNote")
                        .WithMany("NotesFilm")
                        .HasForeignKey("FilmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("R401_TP4.Models.EntityFramework.Utilisateur", "UtilisateurNotant")
